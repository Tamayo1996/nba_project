...
# Forzamos a Keras a usar PyTorch
...
with tab1:
    ...
    with col1:
        nombre_input = st.text_input("Nombre o Apellido del Jugador:", placeholder="Ej. Curry, Harden, James...")
    with col2:
        ano_input = st.text_input("Año de la Temporada:", placeholder=f"Ej. {max_year}")
            ...
            if coincidencias.empty:
                ...
                with res_col2:
                    ...
                    if os.path.exists("grafico_dispersion.png"):
                        st.image("grafico_dispersion.png", caption="Análisis de dispersión muestral generado nativamente en R (ggplot2)")
# ==========================================
...
with tab3:
    ...
    with p_col1:
        nombre_proy = st.text_input("Nombre o Apellido del Jugador a proyectar:", placeholder="Ej. Michael Jordan...", key="nombre_p")
    with p_col2:
